...
import { placement, selectOptions } from '../siteAdUnitSizes';
...
export class AddAppAdUnitsComponent implements OnInit{
  ...
  addAppAdUnit(Data: any) {
    const formData = {
      ...
      os: this.osFetched,
      format: 'Native',
      parentAdUnitId: Data.parentAdUnit,
    }
    ...
    this.userService.addAppAdUnit(formData).subscribe(
      (response) => {
        ...
        alert('Successfully data added to app_ad_unit');
